...
function makeStyles({ illustrationSize, avatarSize, paddingHorizontalResponsive, isTabletLandscape, isLandscape, isSmallDevice, titleSizeResponsive, subtitleSizeResponsive }: any) {
  return StyleSheet.create({
    ...
    scrollContent: { paddingTop: isSmallDevice ? 40 : 60, paddingBottom: 40, paddingHorizontal: paddingHorizontalResponsive },
    ...
    contentContainer: { justifyContent: 'center', alignItems: 'center', flexDirection: isTabletLandscape ? 'row' : 'column' },
